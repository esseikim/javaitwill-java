...
// MVC 아키텍쳐에서 Model에 해당하는 클래스- 데이터 저장용 클래스. 
// 데이터베이스에서 정의된 테이블의 모양을 자바의 클래스로 선언하기 위해서 
// 테이블의 컬럼들을 클래스의 필드로 선언. 

public class Blog {  
	// 테이블 이름과 컬럼 이름들을 상수로 정의. 
	public interface Entity{  // public! 인터페이스의 변수는 어차피 public static final. Blog 테이블에서만 사용될 것 -> 내부인터페이스로 넣어줌.  
	...
	public String toString() {
		...
		// String도 객체. LocalDateTime도 자동으로 만들어줌. 
	}
